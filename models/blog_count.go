...
type BlogCount struct {
	...
	Key  string `xorm:"not null key('统计key') VARCHAR(40)" json:"Key"`
	Val  string `xorm:"not null val('统计值') VARCHAR(40)" json:"val"`
	Desc string `xorm:"not null desc('统计值') VARCHAR(40)" json:"desc"`
